...
public class CartController {
    ...
    public String viewCart(Model model, Principal principal, HttpSession session) {
        ...
        model.addAttribute("stringingServices", stringingServiceRepository.findByIsActiveTrue());
        // Just getting all string products for simplicty, should filter by availability
